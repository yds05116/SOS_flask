...
class User(UserMixin):
    def __init__(self, user_id, user_email, sos_id):
        self.id = user_id
    ...
    def get(user_id):
        ...
        user = User(user_id=user[0], user_email=user[1], sos_id=user[2])
        return user
